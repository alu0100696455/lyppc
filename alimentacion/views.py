...
def stigler(request, muestreo=0, repeticiones=1):
    ...
    if muestreo == 0:
        ...
        for i in range(muestreo):
            ...
            data += [[
                'Alimento ' + str(i + 1),       random.uniform(1, 500),         random.uniform(0.01, 1.00),
                random.uniform(1.00, 50.00),    random.uniform(0.00, 2000.00),  random.uniform(0.00, 20.00),
                random.uniform(0.00, 500.00),   random.uniform(0.00, 200.00),   random.uniform(0.00, 50.00),
                random.uniform(0.00, 100.00),   random.uniform(0.00, 500.00),   random.uniform(0.00, 3000.00)
            ]]
...
def knapsack_multidimensional(request, muestreo=0, repeticiones=1):
    # Nombre, Unidad, Precio (euros), Calorias, Proteínas (g), Calcio (g), Hierro (mg),
    # Vitamina A (IU), Vitamina B1 (mg), Vitamina B2 (mg), Vitamina B3 (mg), Vitamina C (mg)
    if muestreo == 0:
        data = list(Alimento.objects.values_list('nombre', 'unidad', 'precio', 'calorias', 'proteinas', 'calcio', 'hierro', 'vitamina_a', 'vitamina_b1', 'vitamina_b2', 'vitamina_b3', 'vitamina_c'))
